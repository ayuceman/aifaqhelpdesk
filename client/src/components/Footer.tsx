        ...
        <div className="py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12">
          ...
          <div className="lg:col-span-2">
            <Link to="/" className="flex items-center space-x-3 mb-6 group">
              <div className="w-10 h-10 bg-gradient-to-br from-blue-600 to-indigo-600 rounded-xl flex items-center justify-center shadow-lg group-hover:shadow-blue-500/50 transition-shadow">
                <span className="text-white font-bold text-lg">AI</span>
              </div>
              <span className="text-xl font-bold text-white">FAQ Generator</span>
            </Link>
            <p className="text-slate-400 mb-6 leading-relaxed max-w-md">
              Transform your content into intelligent FAQ systems with AI-powered automation. 
        ...
        <div className="border-t border-slate-800 py-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-sm text-slate-500">
              © {currentYear} AI FAQ Generator. All rights reserved.
            </p>
            <div className="flex items-center space-x-6 text-sm">
              <a href="mailto:support@aifaqgenerator.com" className="flex items-center space-x-2 hover:text-white transition-colors">
                <EnvelopeIcon className="w-4 h-4" />
                <span>support@aifaqgenerator.com</span>
              </a>
            </div>
          </div>
        </div>
